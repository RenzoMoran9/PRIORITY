...
(function () {
  ...
  async function enviarADrive(nombre, contenido) {
    ...
    try {
      ...
      // Abrir la app con doble clic (file://) hace que el navegador bloquee la
      // lectura de la respuesta. Se reintenta "a ciegas": el envío sí llega.
      try {
        await fetch(drive.url, Object.assign({}, opciones, { mode: "no-cors" }));
